...
![Installed Apache on Bodhi Linux]({{ site.url }}/img/2020-04-01-150653_1280x800_scrot.png "Installed Apache on Bodhi Linux")
...
![Authorities tab in certificate settings of Chromium]({{ site.url }}/img/2020-04-05-015425_1280x800_scrot.png "Authorities tab in certificate settings of Chromium")



Then navigate to the location where you have kept your `rootCA.crt` file. 

![rootCA.crt file]({{ site.url }}/img/2020-04-05-015904_1280x800_scrot.png "rootCA.crt file")

Open it and select the checkbox telling, “Trust this certificate for identifying websites”.

![checkbox for trusting certificate]({{ site.url }}/img/2020-04-05-020001_1280x800_scrot.png "checkbox for trusting certificate")

Then press “ok”.

Lastly, navigate to `https://localhost` and see if the certificate exists or not.

![Existance of SSL certificate]({{ site.url }}/img/2020-04-05-020329_1280x800_scrot.png "Existance of SSL certificate")
